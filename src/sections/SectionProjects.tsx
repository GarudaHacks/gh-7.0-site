...
function ProjectCard({
  ...
  return (
    <div
      className="flex flex-col gap-4 mx-4 w-[340px] shrink-0 group cursor-pointer bg-white border border-[rgba(124,58,237,0.2)]/60 hover:border-[#874FFE] rounded-2xl p-5 shadow-sm hover:shadow-xl hover:shadow-[#C4A9FF]/20 hover:-translate-y-1.5 transition-all duration-300 relative overflow-hidden"
    ...
    >
      ...
      <div className="relative z-10 flex justify-between items-center mb-1">
        <h3 className="font-bold text-[#f8f9fa] text-[19px] group-hover:text-[#874FFE] transition-colors duration-300">
          {project.title}
        </h3>
        <span className="font-bold text-[#874FFE] text-[14px] bg-[#1a1a2e] border border-[rgba(124,58,237,0.2)]/50 px-2.5 py-1 rounded-md">
          {project.number}
        </span>
      </div>

      <div className="relative z-10 w-full h-[190px] bg-[#EAE5F4] rounded-xl overflow-hidden border border-[rgba(124,58,237,0.2)]/40 group-hover:border-[rgba(124,58,237,0.2)] transition-colors">
        <img
          src={project.image}
          alt={project.title}
      ...
      <button className="relative z-10 mt-auto bg-[#1a1a2e] border border-[rgba(124,58,237,0.2)] group-hover:bg-[#874FFE] group-hover:border-[#874FFE] transition-colors duration-300 text-[#f8f9fa] group-hover:text-white text-[14px] font-semibold py-3 px-4 rounded-xl w-full flex justify-between items-center">
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-4 mb-5">
          <div className="w-[72px] h-[72px] rounded-lg overflow-hidden bg-[#EAE5F4] shrink-0 relative border border-[rgba(124,58,237,0.2)]/50">
            <img
              src={project.image}
              alt={project.title}
          ...
          <div>
            <h3 className="font-bold text-[#f8f9fa] text-[20px] leading-normal">
              {project.title}
            </h3>
        ...
        <div className="font-medium text-[#f8f9fa] text-[15px] leading-relaxed">
          {project.description}
        </div>
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1440px] px-4 md:px-8 lg:px-[120px] border-r border-l border-[rgba(124,58,237,0.2)]">
        ...
        <div className="py-14 md:py-[90px] flex flex-col gap-10 w-full border-r border-l border-[rgba(124,58,237,0.2)] overflow-hidden">
          <div className="flex items-center justify-center px-6 w-full">
            <h2 className="font-bold text-[#f8f9fa] text-3xl md:text-[48px] leading-normal text-center tracking-tight">
              Project Past
            </h2>
          </div>
