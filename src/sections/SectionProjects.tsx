...
const projects: Project[] = [
  {
    ...
    title: "Jedela",
    number: "01",
    image: "/placeholder-checkered.png",
    description: "Jendela helps ex-convicts find jobs by connecting them with training centers and business partners...",
    teamName: "Team name",
  },
  {
    id: "proj-2",
    ...
    >
      ...
      <div className="relative z-10 w-full h-[190px] bg-[#EAE5F4] rounded-xl overflow-hidden border border-[#C4A9FF]/40 group-hover:border-[#C4A9FF] transition-colors">
        <img
          ...
          onError={(e) => {
            (e.target as HTMLImageElement).src = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKCAYAAACNMs+9AAAAAXNSR0IArs4c6QAAACVJREFUKFNjZCASMDKgAhjR5f7//89ITREjI4wNUw1y0zD1IAQAf3QJ/bT10nAAAAAASUVORK5CYII=";
...
export default function SectionProjectPast() {
  ...
  return (
    <section id="project-past" className="w-full relative border-b border-[#C4A9FF]">
